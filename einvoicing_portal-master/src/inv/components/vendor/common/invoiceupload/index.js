...
import InvoiceQueries from './_components/InvoiceQueries'
							...
							<SplitterLayout>
								...
								<div className="right_pane">
									...
									>
										...
										<Tab icon={<GroupAddOutlinedIcon />} label={t('invoice_queries')} />
									</Tabs>
									...
									onClick={() => {
										validateForm().then((form) => {
											if (form && Object.keys(form).length === 0) {
												...
												alert('Mandatroy fields are missing . please fill before saving as draft')
											}
										})
									}}
								>
